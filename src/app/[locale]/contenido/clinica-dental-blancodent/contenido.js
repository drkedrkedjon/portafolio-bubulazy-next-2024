...
export const contenidoDePagina_ES = {
  ...
  subHero: {
    ...
    contenidoInferior: {
      colUno: ["Página web", "Optimizada para móviles", "Cliente comercial"],
  ...
  aside: {
    bloqueUno: {
      ...
      contenido: [
        "Inicialmente se trataba de una web estática, pero el cliente cambió de idea y también quiso implementar un blog. Eso nos llevó a la decisión de implementar la segunda fase (próximamente) utilizando Eleventy SSG, que es ideal para un blog no muy complejo.",
        "También utilizaremos un plugin para las imágenes que automatizará la entrega en diferentes tamaños y formatos.",
        "En la conversación con el agente de SEO se han encontrado unos puntos que se han corregido para mejorar el posicionamiento de la web en el buscador sin influir en la accesibilidad de la misma.",
      ],
    },
    bloqueDos: {
      imgUno: asideDesktop,
    ...
    bloqueTres: {
      ...
      contenido: [
        "La forma de trabajar de manera eficiente e inteligente, para lograr una mejor productividad, mejores resultados y mejor unión del equipo.",
...
export const contenidoDePagina_EN = {
  ...
  subHero: {
    ...
    contenidoSuperior:
      "The Blancodent dental clinic website was published on Squarespace with one of its templates and the design thoroughly modified. The client's wish was to move the website to another platform while maintaining the design and a new code base, and in the process make changes to the organization of the content (completed), implement a blog with a new CMS (upcoming), and finally introduce an online store (final phase) to offer customers discounts and online service sales.",
    tituloInferior: ["Type:", "Tools:", "Live:"],
    contenidoInferior: {
      colUno: ["Website", "Optimized for mobile", "Commercial client"],
      colDos: ["CSS & HTML", "Git & GitHub", "Netlify"],
      colTres: ["https://blancodent.com"],
    },
  },
  main: {
    bloqueUno: {
      ...
      contenido: [
        ...
        "In the first phase (completed), the existing design in Squarespace was simply copied over to Netlify and a new code base was created. In the process, a new hero segment with several offers was added.",
        "In the second phase (currently working on this), the code base will be transferred to Eleventy (static site generator), which will help with the reorganization of the website and implementation of a CMS.",
    ...
    bloqueDos: {
      ...
      contenido: [
        ...
        "My role in this project has been to analyze the current design and transfer it to the new code using the latest CSS technologies.",
        "Subsequently, I reviewed and debugged all the code to eliminate errors. With this, we have managed to improve the website in a complete and efficient manner.",
        "I collaborated with my project partner to develop the design and structure to make the page accessible and, above all, fast.",
      ],
    },
    bloqueTres: {
      imgUno: mainDesktop,
    ...
    bloqueCuatro: {
      ...
      contenido: [
        "With the existing design in the first phase, we focused on the following:",
        ...
        "CSS: Use of Flexbox and Grid by default to organize layout and transfer the design. Intensive use of CSS variables (with default values) and utility classes. New pseudo-classes such as :where() and :clamp().",
  ...
  aside: {
    bloqueUno: {
      ...
      contenido: [
        ...
        "We will also use a plugin for images that will automate delivery in different sizes and formats.",
    ...
    bloqueTres: {
      ...
      contenido: [
        "The way to work efficiently and intelligently, to achieve better productivity, better results, and better team unity.",
        "Frequently review whether we are moving in the right direction that our clients need or if we need to adapt to them.",
        "Learning from each lesson is one of the most important aspects of programming, as this way the mistakes and successes of the projects are recorded to be used in future initiatives, and in this way continuous improvement is achieved.",
      ],
    },
  },
  infoLink: {
